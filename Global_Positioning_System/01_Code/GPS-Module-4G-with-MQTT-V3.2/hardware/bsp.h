...
extern "C" {
    ...
    */
    ...
    #define BSP_RELAY_3                     LATBbits.LATB14
    #define BSP_RELAY_4                     LATBbits.LATB15

    #define BSP_RELAY_1_TRIS                TRISAbits.TRISA10
    #define BSP_RELAY_2_TRIS                TRISAbits.TRISA7
    #define BSP_RELAY_3_TRIS                TRISBbits.TRISB14
    #define BSP_RELAY_4_TRIS                TRISBbits.TRISB15
    ...
    /* ********************************************************************** */
    /* Section: MCP73833 charge controller IC feedback lines                  */
    /* ********************************************************************** */   
    #define MCP73833_PG_PORT                C
    #define MCP73833_PG_PIN                 3

    #define MCP73833_STATUS1_PORT           A
    #define MCP73833_STATUS1_PIN            4

    #define MCP73833_STATUS2_PORT           A
    #define MCP73833_STATUS2_PIN            9

    #define MCP73833_CHG_ONOFF_PORT         A
    #define MCP73833_CHG_ONOFF_PIN          8
