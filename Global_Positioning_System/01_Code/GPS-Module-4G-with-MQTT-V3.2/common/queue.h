...
extern "C" {
	...
	bool queue_data_stream_push_tail(struct queue *queue, const uint8_t *data, uint16_t len);
	char *queue_data_stream_pop_head(struct queue *queue, char *data, uint16_t *len);
