...
void App_quectel_gps_interface_setup(void)
{
    ...
    if(ret == 1)
    {
        ...
        gps_common_interface.bits.gps_on = true;
        gps_common_interface.bits.gnss_on = true;
    }
    else if(ret == 0)
    {
        // GPS-GNSS is off. Set flag.
        gps_common_interface.bits.gps_on = false;
        gps_common_interface.bits.gnss_on = false;
        return;
    }
    else if(ret == 5)
    {
